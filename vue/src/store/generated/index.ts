...
import DanLCheckersDanlCheckersCheckers from './dan-l/checkers/danl.checkers.checkers'
...
export default { 
  ...
  DanLCheckersDanlCheckersCheckers: load(DanLCheckersDanlCheckersCheckers, 'danl.checkers.checkers'),
